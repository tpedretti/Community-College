...
int WINAPI WinMain (HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
	...
	while (!mIO.IsKeyDown (SDLK_ESCAPE)) { 
		...
		// ----- Game Controls and Inputs RIGHT(Right arrow), Left(Left arrow)
		// ----- Down(Down arrow), X(X key on keybored put's the piece down)
		// ----- Z(Z key on keybored Rotation piece)
		...
		case(SDLK_x):
			{
				if(mBoard.IsPossibleMovement (mGame.mPosX, mGame.mPosY, mGame.mPiece, (mGame.mRotation - 1))) mGame.mRotation = (mGame.mRotation - 1);
				break;
			}
		}
// ----- Vertical movement -----
